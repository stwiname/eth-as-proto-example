...
fs.readFile(process.stdin.fd, (error, input) => {
    ...
    try {
        ...
        for (const fileName of codeGenRequest.getFileToGenerateList()) {
            ...
            const generatedCode = (0, file_1.generateFile)(fileDescriptor, new file_context_1.FileContext(generatorContext, fileDescriptor), compilerOptions, compilerVersion);
